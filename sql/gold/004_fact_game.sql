...
USING (
    SELECT
        ...
        g.status,
        g.home_team_id,
        g.home_team_id * 10000 + g.season_year AS home_team_season_key,
        ht.team_name        AS home_team_name,
        ht.team_abbrev      AS home_team_abbrev,
        g.away_team_id,
        g.away_team_id * 10000 + g.season_year AS away_team_season_key,
...
WHEN NOT MATCHED THEN INSERT (
    ...
    home_team_id, home_team_season_key, home_team_name, home_team_abbrev,
    away_team_id, away_team_season_key, away_team_name, away_team_abbrev,
    ...
    src.home_team_id, src.home_team_season_key, src.home_team_name, src.home_team_abbrev,
    src.away_team_id, src.away_team_season_key, src.away_team_name, src.away_team_abbrev,
